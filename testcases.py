...
assert check("int main(){int a;for(a=0;a<10;a=a+1)b=a;return b;}", 9)
assert check("int main(){for(;;)return 0;}", 0)


assert check("int main(){int b;int a;b=0;for(a=0;a<10;a=a+1){b=b+3;}return b;}", 30)
assert check("int main(){int b;b=0;{b=b+3;}return b;}", 3)
assert check("int main(){int b; int a;b=0;for(a=0;a<10;a=a+1){b=b+1;b=b+2;}return b;}", 30)
...
assert check("int myadd(int a,int b){return a+b;} int main(){return myadd(3,2);}", 5)
assert check("int mysub(int a,int b){return a-b;} int main(){return mysub(3,2);}", 1)

assert check("int mysub3(int a,int b,int c){return a-b-c;} int main(){return mysub3(3,1,1);}", 1)
assert check(
